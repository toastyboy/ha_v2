...
echo '<tr>' . "\n" ;
echo '<td rowspan="12">' . "\n" ;
echo '<img src="http://192.168.100.160/GetData.cgi"  style="width:450px;height:600px;"></td>' . "\n" ;
echo '<br>' . "\n" ;

echo '<td height="50"><font size="16">Recent</font></td>' . "\n" ;
echo '<td> </td></tr>' . "\n" ;
...
echo '<tr>' . "\n" ;
echo 'Change Camera -' . "\n" ;
echo '<a href="porch_cams/cam1.php">1</a>,' . "\n" ;
echo '<a href="porch_cams/cam2.php">2</a>,' . "\n" ;
echo '<a href="porch_cams/cam3.php">3</a>,' . "\n" ;  
echo '<a href="porch_cams/cam4.php">4</a>  </br>' . "\n" ;
echo '<p>' . "\n" ;
